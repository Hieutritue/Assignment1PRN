...
namespace Assignment1PRN.Models;

public partial class FuminiHotelManagementContext : DbContext
{
    private static FuminiHotelManagementContext _instance;
    public static FuminiHotelManagementContext Instance()
    {
        if (_instance == null)
            _instance = new FuminiHotelManagementContext();
        return _instance;
    }
    private FuminiHotelManagementContext()
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=THAILEHIEU;Database=FUMiniHotelManagement;User Id=sa;Password=123;Encrypt=False;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A14740F99DBF25").IsUnique();
